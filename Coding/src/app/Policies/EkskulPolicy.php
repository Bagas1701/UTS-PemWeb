...
class EkskulPolicy
{
    ...
    {
        return $user->can('view_any_ekskul');
    }
    ...
    {
        return $user->can('delete_any_ekskul');
    }
     ...
     */
    public function replicate(User $user, Ekskul $ekskul): bool
    {
